                            ...
                            <div className="card">
                                <div className="card-body">
                                    <h3 className="text-center mt-0 m-b-15">
                                        <a href="#" className="logo logo-admin"><img src="assets/images/logo-dark.png" height={30} alt="logo" /></a>
                                    </h3>
                                        ...
                                        <form className="form-horizontal " action="#">
                                            ...
                                            <div className="form-group text-center row m-t-20">
                                                <div className="col-12">
                                                    <button className="btn btn-primary btn-block waves-effect waves-light" type="submit">Verify OTP</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
